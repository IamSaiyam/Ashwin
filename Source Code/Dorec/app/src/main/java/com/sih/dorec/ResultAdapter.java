...
public class ResultAdapter extends RecyclerView.Adapter<ResultAdapter.ViewHolder>{
    ArrayList<PanUtil> dataList = new ArrayList<>();
    AadharUtil selected = new AadharUtil();
    Context context;

    public ResultAdapter(ArrayList<PanUtil> dataList, AadharUtil selected, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        double similarityPercent = ((jaro_Winkler(selected.getFirstName(), dataList.get(position).getFistName())*100) + (jaro_Winkler(selected.getLastName(), dataList.get(position).getLastName())*100)
        ...
        if(similarityPercent>74.0){
            ...
            id.setText(dataList.get(position).getPan());
            fName.setText(dataList.get(position).getFistName());
